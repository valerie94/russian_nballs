...
def fix_dim(maxsize, mindim, word2ballDic=dict(), bPath = 'glove.6B.50Xball'):
    """
    :param maxsize:
    :param mindim:
    :param word2ballDic:
...
def make_DC_for_first_level_children(root="*root*", firstChild = 'время.n.3', wsChildrenDic=dict(),
...
def train_word2ball(root="",  outputPath = '', logFile='', wsChildrenDic=dict(),
    ...
    make_DC_for_first_level_children(root=root, firstChild = 'время.n.3', wsChildrenDic=wsChildrenDic,
                                                    word2ballDic=word2ballDic, outputPath=outputPath,
